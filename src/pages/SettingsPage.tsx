...
import { Shield, Palette, Bell, Key, LogOut, MonitorSmartphone, Settings as SettingsIcon, UserCircle, Globe, Mail } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const handleVisibilityToggle = async () => {
    ...
    try {
      ...
      toast.success(`Profile visibility updated to ${newVisibility.toLowerCase()}`);
    } catch {
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/5 via-background to-background border border-border/50 p-8 sm:p-10 mb-10 shadow-sm">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
            Manage your account preferences, security, and personalize your experience.
          </p>
        </div>
      </div>
                ...
                <section className="bg-card border border-border/50 rounded-3xl p-6 sm:p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Customize your UI theme and preferences.</p>
                    </div>
                  </div>
                  ...
                  <div className="p-5 rounded-2xl border border-border/50 bg-background flex items-center justify-between gap-4">
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1 max-w-md">
                          Currently, the application forces a high-contrast dark theme for optimal developer experience.
                        </p>
                      </div>
                    </div>
                    <button
                ...
                <section className="bg-card border border-border/50 rounded-3xl p-6 sm:p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Manage your alerts and email communications.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="p-5 rounded-2xl border border-border/50 bg-background flex items-center justify-between gap-4">
                      <div className="flex gap-4 items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1 max-w-md">Receive digests, mentions, and important system alerts directly to your inbox.</p>
                        </div>
                      </div>
                    ...
                    <div className="p-5 rounded-2xl border border-border/50 bg-background flex items-center justify-between gap-4">
                      <div className="flex gap-4 items-start">
                        ...
                        <div>
                          <p className="text-sm font-bold text-foreground">Marketing & News</p>
                          <p className="text-sm text-muted-foreground mt-1 max-w-md">Receive occasional platform updates, feature announcements, and developer news.</p>
                        </div>
                      </div>
                ...
                <section className="bg-card border border-border/50 rounded-3xl p-6 sm:p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Update your account password and secure your profile.</p>
                    </div>
                  </div>
              ...
              {activeTab === 'account' && (
                <section className="bg-card border border-border/50 rounded-3xl p-6 sm:p-8 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-foreground">Account & Sessions</h2>
                      <p className="text-sm text-muted-foreground">Manage your active sessions and account actions.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4 max-w-md">
                    <div className="p-5 rounded-2xl border border-border/50 bg-background">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">Log out of your current session on this browser.</p>
                        </div>
                      </div>
                      <Button
                        variant="secondary"
                    ...
                    <div className="p-5 rounded-2xl border border-destructive/20 bg-destructive/5">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div>
                          <p className="text-sm font-bold text-destructive">Sign Out from All Devices</p>
                          <p className="text-sm text-destructive/80 mt-1">Invalidate all active sessions across all your devices immediately.</p>
                        </div>
                      </div>
                      <Button
                        variant="destructive"
