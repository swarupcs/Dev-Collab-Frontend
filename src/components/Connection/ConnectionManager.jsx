...
export function ConnectionsManager() {
  ...
  const connectionRequests = [
    {
      ...
      message: "Hi! I saw your work on the React component library. Would love to connect and discuss best practices!",
    },
    {
      id: "2",
      name: "Alex Rodriguez",
      ...
      message: "Hello! I'm working on a similar project and would appreciate your insights.",
    },
  ]
  ...
  const filteredDevelopers = suggestedDevelopers.filter((dev) => {
    const matchesSearch =
      dev.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      dev.skills.some((skill) => skill.toLowerCase().includes(searchQuery.toLowerCase()))
    const matchesSkill = skillFilter === "all" || dev.skills.includes(skillFilter)
    const matchesLocation = locationFilter === "all" || dev.location.includes(locationFilter)
        ...
        <TabsContent value="discover" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Find and connect with developers who share your interests</CardDescription>
            </CardHeader>
                ...
                {filteredDevelopers.map((developer) => (
                  <Card key={developer.id} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-6">
                          ...
                          <div className="relative">
                            ...
                            <div
                              className={`absolute -bottom-1 -right-1 h-3 w-3 rounded-full border-2 border-background ${
                                developer.status === "online" ? "bg-green-500" : "bg-gray-400"
                              }`}
                            />
                          </div>
                          <div>
                            ...
                            <div className="flex items-center gap-1 mt-1">
                              ...
                              <span className="text-xs text-muted-foreground">{developer.location}</span>
                            </div>
                          </div>
                        </div>
                      ...
                      <p className="text-sm text-muted-foreground mb-3">{developer.bio}</p>
                      ...
                      <div className="flex items-center justify-between text-xs text-muted-foreground mb-4">
                        ...
                        <span>{developer.connections} connections</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button size="sm" onClick={() => handleSendConnectionRequest(developer.id)}>
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-muted-foreground mt-2">
                              {request.mutualConnections} mutual connections • {request.requestDate}
                            </p>
                            {request.message && (
        ...
        <TabsContent value="connections" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your developer connections ({myConnections.length} total)</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                ...
                {myConnections.map((connection) => (
                  <Card key={connection.id} className="hover:shadow-md transition-shadow">
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">{connection.bio}</p>
